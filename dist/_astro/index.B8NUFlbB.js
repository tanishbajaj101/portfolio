...
function Y() {
  ...
  ((m.constructor = v), $(m, y.prototype), (m.isPureReactComponent = !0));
  var j = Array.isArray,
  ...
  function P(e, t, n) {
    ...
    if (t != null)
      for (u in (t.ref !== void 0 && (s = t.ref), t.key !== void 0 && (c = '' + t.key), t))
        O.call(t, u) && !x.hasOwnProperty(u) && (o[u] = t[u]);
    ...
    return { $$typeof: a, type: e, key: c, ref: s, props: o, _owner: S.current };
  }
  function W(e, t) {
  ...
  function d(e, t, n, u, o) {
          ...
          : o != null &&
            (R(o) &&
              (o = W(
                o,
                n +
                  (!o.key || (s && s.key === o.key) ? '' : ('' + o.key).replace(I, '$&/') + '/') +
                  e,
              )),
            t.push(o)),
        1
    ...
    if (((s = 0), (u = u === '' ? '.' : u + ':'), j(e)))
      ...
      for (e = i.call(e), f = 0; !(c = e.next()).done;)
        ((c = c.value), (i = u + w(c, f++)), (s += d(c, t, n, i, o)));
    else if (c === 'object')
      throw (
        (t = String(e)),
        Error(
  ...
  return (
    ...
    (r.cloneElement = function (e, t, n) {
      ...
      return { $$typeof: a, type: e.type, key: o, ref: c, props: u, _owner: s };
    }),
...
var D;
function Z() {
  return (D || ((D = 1), (E.exports = Y())), E.exports);
}
var ee = Z();
const re = X(ee);
export { re as R, Z as a, te as c, X as g, ee as r };
