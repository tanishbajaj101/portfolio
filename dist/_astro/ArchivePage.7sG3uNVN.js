import { q as w, P as k, j as e } from './GlobalStyle.Bb7mjjE7.js';
import { r as a } from './index.B8NUFlbB.js';
import { s as d } from './config.8JBl_d4u.js';
import { s as o } from './sr.BrDI4Z8O.js';
import { L as N } from './side.D2ortFwv.js';
import './footer.23J8IVI4.js';
import './jobs.CbeqI7LU.js';
import './projects.C1ZTG5l-.js';
import { I as t } from './twitter.BDuDRxDo.js';
import { u as z } from './index.DF2av5RA.js';
const P = w.div.withConfig({
    displayName: 'ArchivePage__StyledTableContainer',
    componentId: 'sc-1jnu9to-0',
  })(
    [
  ...
  A = ({ projects: r }) => {
    ...
    return (
      a.useEffect(() => {
        b ||
          (o.reveal(h.current, d()),
          o.reveal(c.current, d(200, 0)),
          p.current.forEach((s, i) => o.reveal(s, d(i * 10))));
      }, []),
      e.jsx(N, {
        pathname: '/archive',
        children: e.jsxs('main', {
          children: [
            e.jsxs('header', {
              ref: h,
              children: [
                e.jsx('h1', { className: 'big-heading', children: 'Archive' }),
                e.jsx('p', {
                  className: 'subtitle',
                  children: "A big list of things I've worked on",
                }),
              ],
            }),
            e.jsx(P, {
              ...
              children: e.jsxs('table', {
                children: [
                  e.jsx('thead', {
                    children: e.jsxs('tr', {
                      children: [
                        e.jsx('th', { children: 'Year' }),
                        e.jsx('th', { children: 'Title' }),
                        e.jsx('th', { className: 'hide-on-mobile', children: 'Made at' }),
                        e.jsx('th', { className: 'hide-on-mobile', children: 'Built with' }),
                        e.jsx('th', { children: 'Link' }),
                      ],
                    }),
                  }),
                  e.jsx('tbody', {
                          ...
                          'tr',
                          {
                            ...
                            children: [
                              e.jsx('td', {
                                ...
                                children: `${new Date(v).getFullYear()}`,
                              }),
                              e.jsx('td', { className: 'title', children: y }),
                              e.jsx('td', {
                                  ...
                                  children: [
                                    m &&
                                      e.jsx('a', {
                                        ...
                                        children: e.jsx(t, { name: 'External' }),
                                      }),
                                    x &&
                                      e.jsx('a', {
                                        href: x,
                                        'aria-label': 'GitHub Link',
                                        children: e.jsx(t, { name: 'GitHub' }),
                                      }),
                                    f &&
                                      e.jsx('a', {
                                        href: f,
                                        'aria-label': 'Apple App Store Link',
                                        children: e.jsx(t, { name: 'AppStore' }),
                                      }),
                                    g &&
                                      e.jsx('a', {
                                        href: g,
                                        'aria-label': 'Google Play Store Link',
                                        children: e.jsx(t, { name: 'PlayStore' }),
                                      }),
                                  ],
                                }),
                              }),
...
A.propTypes = { projects: k.array.isRequired };
export { A as default };
